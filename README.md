...
> Answer: A major benefit to client-side routing is that it is faster due to the page not having to refresh when you click a link to another page, or tab. You may notice on some websites a weird flicker between clicks while you're navigating, client-side routing prevents this and provides a much better user experience. 

- [x] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML which. AJAX is used to create faster websites and web applications. It uses XML, HTML, CSS, and JavaScript/DOM to achieve this. 


- [x] What are `controlled components` in React?
> Answer: A controlled component's value changes through props and are made through callbacks. The parent component handles said callback and passes the new values to the controlled component.

- [x] Name three tools/libraries for making AJAX requests.
> Answer: Fetch API, axios, and jQuery are all used for making AJAX requests. 
